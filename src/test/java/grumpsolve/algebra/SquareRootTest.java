...
public class SquareRootTest {
    ...
    public void squareRootZero() throws Exception {
        Expression expression = Algebra.SquareRoot.squareRoot(ZERO);
        assertSame(ZERO, expression);
    }

    @Test
    public void squareRootOne() throws Exception {
        Expression expression = Algebra.SquareRoot.squareRoot(ONE);
        assertSame(ONE, expression);
    }

    @Test
    public void constant() throws Exception {
        Expression expression = Algebra.SquareRoot.squareRoot(HALF);
    ...
    public void parameter() throws Exception {
        Expression expression = Algebra.SquareRoot.squareRoot(x0);
        assertTrue(expression instanceof Algebra.SquareRoot);
